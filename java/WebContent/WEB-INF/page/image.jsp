    ...
    <body>
        <div>
             <ul id="menu">
                ...
                <li id="analyseData"><a href="/Test/analyseData/index.action" title="数据分析"style="color:yellow">数 据 分 析</a></li>
            </ul>
        </div>
        <div id="change">
        ...
        <div id="main">
           <c:forEach items="${images }" var="image">
           		<div class='box'>
                    <div class='pic'>
                        <img alt="图片丢失" src="/file/images/${image }" onclick='fun("${image}")'>
                    </div>
               </div>
           </c:forEach>
        </div>
...
<script type="text/javascript">
    function fun(test){
        ...
        image1.src='/file/images/'+test;
        image2=document.getElementById('image2');
        image2.src='/file/images/'+test.substring(0,13)+'p.png';
        //请求对应图片的信息
        $.ajax({
           		url:"/Test/analyseData/getImageData.action",
                type:"POST",
    ...
    function change(){
        ...
        $.ajax({
            url:"/Test/analyseData/setImageData.action",
            type:"POST",
            contentType:'application/json;charset=utf-8',
