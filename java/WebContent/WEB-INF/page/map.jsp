        	...
        	$.ajax({
                ...
                success:function(res){
                    if(res.time!="12345"){
                        ...
                        var infoWindow=getInfoWindow("/file/images/"+res.fileName,res.name,res.number,res.time,res.ps);
	...
	<body>
		<div>
             <ul id="menu">
                ...
                <li id="map"><a href="/Test/map/index.action" title="地图"style="color:yellow">分 布 地 图</a></li>
